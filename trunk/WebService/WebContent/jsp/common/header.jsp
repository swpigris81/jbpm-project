...
<script type="text/javascript" src="<%=headerPath %>/js/webservice/system/login.js"></script>
<script type="text/javascript" src="<%=headerPath %>/js/webservice/system/register.js"></script>
