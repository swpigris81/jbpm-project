package com.webservice.system.systembackup.dao.impl;
...
import com.webservice.system.systembackup.dao.ISystemBackupSettingDao;
    ...
    public SystemBackSettingInfo findById( java.lang.String id) {
        ...
        try {
            SystemBackSettingInfo instance = (SystemBackSettingInfo) getHibernateTemplate()
                    .get(SystemBackSettingInfo.class, id);
            return instance;
        } catch (RuntimeException re) {
