package com.webservice.apps.account.action;
...
import com.webservice.apps.account.bean.AccountAlert;
import com.webservice.apps.account.bean.AccountBaseInfo;
import com.webservice.apps.account.bean.AccountCardInfo;
import com.webservice.apps.account.service.IAccountAlertService;
import com.webservice.apps.account.service.IAccountBaseInfoService;
import com.webservice.apps.account.service.IAccountCardInfoService;
import com.webservice.apps.account.service.IBalanceInfoService;
...
public class AccountManageAction extends BaseAction {
     ...
     * 账目恢复时上传的文件
     */
    private File accountImport;
    private String accountImportContentType;
    private String accountImportFileName;
    /**
     * 下载文件名称以及路径
     */
    ...
    /**
     * <p>Discription:[下载模板]</p>
     * @return
     * @author:大牙
     * @update:2012-11-27
     */
    public String download(){
        setFileLoc(Base64Coder.encodeString(getRequest().getRealPath("/")+"doc/账目信息模板.xlsx"));
        setFileName("账目信息模板.xlsx");
        return DOWNLOAD;
    }
    /**
     * <p>Discription:[上传账目信息]</p>
     * @return
     * @author:大牙
     * @update:2012-11-27
     */
    public String uploadAccount(){
        ...
        try{
            ...
            if(accountImport == null){
                resultMap.put("success", false);
                resultMap.put("msg", "请上传账目文件。如不知文件格式，请下载账目文件模板！");
            }else{
                this.accountBaseInfoService.uploadAccountBaseInfo(accountImport);
            }
        }catch(Exception e){
     ...
     * @return File accountImport.
     */
    public File getAccountImport() {
        return accountImport;
    }
    /**
     * <p>Discription:[方法功能中文描述]</p>
     * @param accountImport The accountImport to set.
     */
    public void setAccountImport(File accountImport) {
        this.accountImport = accountImport;
    }
    /**
     * <p>Discription:[方法功能中文描述]</p>
     * @return String accountImportContentType.
     */
    public String getAccountImportContentType() {
        return accountImportContentType;
    }
    /**
     * <p>Discription:[方法功能中文描述]</p>
     * @param accountImportContentType The accountImportContentType to set.
     */
    public void setAccountImportContentType(String accountImportContentType) {
        this.accountImportContentType = accountImportContentType;
    }
    /**
     * <p>Discription:[方法功能中文描述]</p>
     * @return String accountImportFileName.
     */
    public String getAccountImportFileName() {
        return accountImportFileName;
    }
    /**
     * <p>Discription:[方法功能中文描述]</p>
     * @param accountImportFileName The accountImportFileName to set.
     */
    public void setAccountImportFileName(String accountImportFileName) {
        this.accountImportFileName = accountImportFileName;
    }
