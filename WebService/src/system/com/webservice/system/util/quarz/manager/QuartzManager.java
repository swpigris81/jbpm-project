package com.webservice.system.util.quarz.manager;
...
public class QuartzManager {
	...
	public static void addJob(String jobName, Class jobClass, String time) {
	    addJob(null, jobName, jobClass, time);
	}
	
	/**
	 * <p>Discription:添加一个定时任务，使用默认的任务组名，触发器名，触发器组名 </p>
	 * @param jobDataMap 参数Map
     * @param jobName 任务名
     * @param jobClass 任务
     * @param time 时间设置，参考quartz说明文档(Cron 表达式)
	 * @author:大牙
	 * @update:2012-11-23
	 */
	public static void addJob(Map jobDataMap, String jobName, Class jobClass, String time) {
	    try {  
            ...
            if(jobDataMap != null){
                JobDataMap dataMap = new JobDataMap(jobDataMap);
	...
	public static void addJob(String jobName, String jobGroupName,  
	    ...
	    addJob(null, jobName, jobGroupName, triggerName,triggerGroupName, jobClass, time);
	}
	/**
	 * <p>Discription:添加一个定时任务 </p>
	 * @param jobDataMap 任务参数MAP
     * @param jobName 任务名
     * @param jobGroupName 任务组名
     * @param triggerName 触发器名 
     * @param triggerGroupName 触发器组名
	 ...
	 * @update:2012-11-23
	 */
	public static void addJob(Map jobDataMap, String jobName, String jobGroupName,  
            String triggerName, String triggerGroupName, String jobClass, String time){
	    try {  
            Scheduler sched = gSchedulerFactory.getScheduler();  
	...
	/**
	 * <p>Discription:获取指定名称指定组名称的任务</p>
	 * @param jobName 任务名称
	 ...
	 * @update:2012-11-23
	 */
	public static JobDetail getJobDetail(String jobName, String jobGroupName){
	    try{
	        Scheduler sched = gSchedulerFactory.getScheduler();
	        if(jobGroupName == null || "".equals(jobGroupName.trim())){
